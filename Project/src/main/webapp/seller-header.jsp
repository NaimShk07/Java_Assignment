...
<%
	...
	if (session.getAttribute("user") != null) {
		u = (Seller) session.getAttribute("user");
	}
			...
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<div class="header__logo">
						<a href="./seller-home.jsp"><img src="img/logo.png" alt=""></a>
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<nav class="header__menu mobile-menu">
						<ul>
							...
							<li><a href="#">Product</a>
								<ul class="dropdown ">
									<li><a href="seller-upload-product.jsp">Add product</a></li>
				...
				<div class="col-lg-3 col-md-3">
					<div class="header__nav__option">
						<a href="#" class="search-switch"><img
							...
							src="img/icon/heart.png" alt=""></a> <a
							href="shopping-cart.html"><img src="img/icon/cart.png" alt="">
							<span>0</span></a>
